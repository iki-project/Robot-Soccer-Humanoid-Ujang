...
Head::Head()
{
	...
	m_BottomLimit = Kinematics::EYE_TILT_OFFSET_ANGLE - 65;//-75
	
	m_Pan_Home = 0.0;
	m_Tilt_Home = Kinematics::EYE_TILT_OFFSET_ANGLE - 10.0;//-20
...
bool Start=true;
int count=0;
double time_move=0.6;  //0.8 setting waktu putar kepala
int move_value=4;
int pan_move=0;
int tilt_move=0;
