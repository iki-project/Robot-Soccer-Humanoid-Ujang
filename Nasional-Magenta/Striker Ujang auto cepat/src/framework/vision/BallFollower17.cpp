...
BallFollower::BallFollower()
{
	...
	m_FollowMaxRLTurn 	= 20.0; // awal 20
	m_FitFBStep 		= 3.0;
	m_FitMaxRLTurn 		= 13.0;
	m_UnitFBStep 		= 1;
	m_UnitRLTurn 		= 0.3;
...
void jTempatAwal()
{
	...
	Walking::GetInstance()->HIP_PITCH_OFFSET = 34.5;
	Walking::GetInstance()->A_MOVE_AMPLITUDE = 0.0;
	Walking::GetInstance()->Z_MOVE_AMPLITUDE = 15.0;
...
void jMaju2()
{
	...
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 34.5;
	Walking::GetInstance()->A_MOVE_AMPLITUDE = 5.0;// 2.0;
	Walking::GetInstance()->Z_MOVE_AMPLITUDE = 30;
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 25;
	fprintf(stderr, "jalan maju awal \n");
}
void jMaju1()
{
	Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 34.7;
	Walking::GetInstance()->A_MOVE_AMPLITUDE = 5.0;// 2.0;
	Walking::GetInstance()->Z_MOVE_AMPLITUDE = 30;
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 17.5;
	fprintf(stderr, "jalan maju awal \n");
}
void berhen()
{
...
void pasBola1()
{
    ...
    Walking::GetInstance()->Z_MOVE_AMPLITUDE = 25.0;//foot heigh
    Walking::GetInstance()->A_MOVE_AMPLITUDE = 27.0;
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 8.0;//maju8 mundur}
	fprintf(stderr, "depan Bola ke 1\n");
}
...
void pasBola2()
{
	...
	//Walking::GetInstance()->HIP_PITCH_OFFSET = 45.5;
    Walking::GetInstance()->Z_MOVE_AMPLITUDE = 25.0;//foot heigh
    Walking::GetInstance()->A_MOVE_AMPLITUDE =-28.5;
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 5.0;//maju mundur}
	fprintf(stderr, "depan Bola ke 2\n");
}
void pasBola3()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	...
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 5.0;//maju mundur}
	fprintf(stderr, "depan Bola ke nyamping 1\n");
}
void pasBola4()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	...
	//Walking::GetInstance()->HIP_PITCH_OFFSET = 45.5;
    Walking::GetInstance()->Z_MOVE_AMPLITUDE = 25.0;//foot heigh
    Walking::GetInstance()->A_MOVE_AMPLITUDE =-28.0;
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 5.0;//maju mundur}
	fprintf(stderr, "depan Bola ke nyamping 2\n");
}
void peralihanNendang1()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 31.0;
    Walking::GetInstance()->Z_MOVE_AMPLITUDE = 25.0;//foot heigh
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 3.0;//maju mundur}
	Walking::GetInstance()->A_MOVE_AMPLITUDE = -5.0;
	fprintf(stderr, "peralihan\n");
}
void peralihanMundur1()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 31.0;
    Walking::GetInstance()->Z_MOVE_AMPLITUDE = 30.0;//foot heigh
	Walking::GetInstance()->X_MOVE_AMPLITUDE = -5.0;//maju mundur}
	//Walking::GetInstance()->A_MOVE_AMPLITUDE = -8.0;
	Walking::GetInstance()->Y_MOVE_AMPLITUDE = -5.0;
	fprintf(stderr, "peralihan mundur\n");
}
void peralihanMundur2()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 31.0;
    Walking::GetInstance()->Z_MOVE_AMPLITUDE = 30.0;//foot heigh
	Walking::GetInstance()->X_MOVE_AMPLITUDE = -4.5;//maju mundur}
	//Walking::GetInstance()->A_MOVE_AMPLITUDE = -8.0;
	Walking::GetInstance()->Y_MOVE_AMPLITUDE = -5.0;
	fprintf(stderr, "peralihan mundur\n");
}
void peralihanMundur5()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 31.0;
    Walking::GetInstance()->Z_MOVE_AMPLITUDE = 30.0;//foot heigh
	Walking::GetInstance()->X_MOVE_AMPLITUDE = -3;//maju mundur}
	Walking::GetInstance()->A_MOVE_AMPLITUDE = 10;
	//Walking::GetInstance()->Y_MOVE_AMPLITUDE = -5.0;
	fprintf(stderr, "peralihan mundur\n");
}
void peralihanMundur3()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
...
void habisNendang()
{
	...
	Walking::GetInstance()->Start();
	//Walking::GetInstance()->HIP_PITCH_OFFSET = 45.5;
    Walking::GetInstance()->Z_MOVE_AMPLITUDE = 15.0;//foot heigh
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 0;//maju mundur}
	Walking::GetInstance()->A_MOVE_AMPLITUDE = 0;
	fprintf(stderr, "habis kick\n");
}
void nyampingKanan()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
...
void cobaberhen()
{
	Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 32;
    //Walking::GetInstance()->BALANCE_ENABLE =true;
...
void riset1()
{
	...
	Walking::GetInstance()->HIP_PITCH_OFFSET = 34.0;
    Walking::GetInstance()->Z_MOVE_AMPLITUDE = 30.0;//foot heigh
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 7.0;//maju mundur}
...
void riset2()
{
	...
	Walking::GetInstance()->HIP_PITCH_OFFSET = 34.0;
    Walking::GetInstance()->Z_MOVE_AMPLITUDE = 30.0;//foot heigh
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 10.0;//maju mundur}
	Walking::GetInstance()->A_MOVE_AMPLITUDE = -14.0;
	fprintf(stderr, " mundur\n");
}
void riset3()
{
	...
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 34.0;
	Walking::GetInstance()->A_MOVE_AMPLITUDE = 0.0;// 2.0;
	Walking::GetInstance()->Z_MOVE_AMPLITUDE = 25;
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 15;
	fprintf(stderr, "jalan maju awal \n");
	fprintf(stderr, " mundur\n");
...
if(DEBUG_PRINT == true)
	...
	if(posX == -1.0 || posY == -1.0)
		{
			...
			if(m_NoBallCount > m_NoBallMaxCount)
			{
				...
				{
					Walking::GetInstance()->X_MOVE_AMPLITUDE = 0; //15
					//Walking::GetInstance()->A_MOVE_AMPLITUDE = 10;
	...
	if(pan > m_KickRightAngle && pan < m_KickLeftAngle)
		{
			...
			/*if (tilt <=-14)
			{
				cout<<"ke kanan dikit"<<endl;
				 siap3();
				 usleep(3000000);
				//if (0 >= pan >=0 && delta == false )
					//	{
						//	fprintf(stderr, "ready go\n");						
							//usleep(1000000);
							//coba();
							//usleep(4000000);
							//fprintf(stderr, " tendang sekali\n");
                            		
							KickBall = -1; // Right
							Tendang();
							Action::GetInstance()->Start(133);
                            usleep(6500000);
                            fprintf(stderr, " fokius gogok\n");	
                              usleep(15500000);
	...
	//	if(pan > m_KickRightAngle && pan < m_KickLeftAngle)
		//{
			//geser = false;
			//if(tilt <= (-50 + MX28::RATIO_VALUE2ANGLE))
			//if(tilt <= (-30 + MX28::RATIO_VALUE2ANGLE)S
			
			if(tilt<= -16  && tilt >= - 26)//(tilt<= 10  && tilt >= 5)
			{
  				...
  				if(m_KickBallCount >= 0 )
					{
						...
						if(DEBUG_PRINT == true)
							...
							fprintf(stderr,"nendang 1\n");	
							Tendang();
							usleep(1500000);
							Action::GetInstance()->Start(147); 
							usleep(8000000);
							//habisNendang();
							//usleep(3000000);
	...
	if(m_GoalFBStep == 0 && m_GoalRLTurn == 0 && m_FBStep == 0 && m_RLTurn == 0)
		...
		else
		{
			...
			FB_move+=3;//kalibrasi dari setting walk tunner
	...
	*/
		if (m_FBStep >=1 && angkat ==0)
				...
				Walking::GetInstance()->P_OFFSET=5.8;
				...
				Walking::GetInstance()->P_OFFSET=8;
