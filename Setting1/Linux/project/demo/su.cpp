...
void jalan1()
{
	Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();	
	Walking::GetInstance()->HIP_PITCH_OFFSET = 20.3;
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 10;
	usleep(6000000);
}
void jalan2()
{
	Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 20.2;	
...
{
	Walking::GetInstance()->Start();
	Walking::GetInstance()->PERIOD_TIME =565;
	Walking::GetInstance()->HIP_PITCH_OFFSET = 26.5;
	Walking::GetInstance()->Z_MOVE_AMPLITUDE = 30;
	Walking::GetInstance()->X_MOVE_AMPLITUDE = -10; //step forward back (mm)
   Walking::GetInstance()->Y_MOVE_AMPLITUDE =  -40; //step right left (mm)
	Walking::GetInstance()->A_MOVE_AMPLITUDE = 4;//step direction (degree)
}
int main(void)
{
