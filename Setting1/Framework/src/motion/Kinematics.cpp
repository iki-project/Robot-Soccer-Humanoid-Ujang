...
const double Kinematics::CAMERA_DISTANCE = 34.0; //33.2mm
const double Kinematics::EYE_TILT_OFFSET_ANGLE = 40.0; //40.0degree
...
const double Kinematics::LEG_LENGTH = 303; //219.5mm (THIGH_LENGTH + CALF_LENGTH + ANKLE_LENGTH)
