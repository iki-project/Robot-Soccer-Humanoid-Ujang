...
void pasBola()
{
	...
	Walking::GetInstance()->X_MOVE_AMPLITUDE = 8.0;//maju mundur}
	fprintf(stderr, "depan Bola\n");
}
void coba2()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
...
void cobaberhen()
{
	Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 33;
    //Walking::GetInstance()->BALANCE_ENABLE =true;
    Walking::GetInstance()->Z_MOVE_AMPLITUDE =25;//foot heigh
    Walking::GetInstance()->A_MOVE_AMPLITUDE =8.0;
	Walking::GetInstance()->X_MOVE_AMPLITUDE =0;//maju mundur
...
void knn()
{
    ...
    //Walking::GetInstance()->BALANCE_ENABLE =true;
    Walking::GetInstance()->Z_MOVE_AMPLITUDE =25;//foot heigh
    Walking::GetInstance()->A_MOVE_AMPLITUDE =16.0;
	Walking::GetInstance()->X_MOVE_AMPLITUDE =0;//maju mundur
}
  					...
  					if(m_KickBallCount >= 0 )
					{
						...
						/*	  coba();
							 ...
							 // usleep(1000000);
								...
								Tendang();
								usleep(1500000);
								Action::GetInstance()->Start(124); // gada motion di nomer 50
								usleep(8000000);
								cobaberhen();
								usleep(4000000);
								...
								{
									Walking::GetInstance()->Stop();
									fprintf(stderr,"nendang nyamping 1\n");	
									Tendang();
									usleep(2000000);
									Action::GetInstance()->Start(133); 
									usleep(8000000);
								...
								{
									Walking::GetInstance()->Stop();
									fprintf(stderr,"nendang nyamping 2\n");	
									Tendang();
									usleep(2000000);
									Action::GetInstance()->Start(133); 
									usleep(8000000);
								...
								{
									Walking::GetInstance()->Stop();
									fprintf(stderr,"nendang nyamping 3\n");	
									Tendang();
									usleep(2000000);
									Action::GetInstance()->Start(133); 
									usleep(8000000);
