					...
					{	
						...
						if(DEBUG_PRINT == true)
							...
							if (jumlah_nendang == 2)
							{
								...
								Tendang();
								usleep(1500000);
								Action::GetInstance()->Start(130); // gada motion di nomer 50
								usleep(8000000);
								cobaberhen();
								usleep(4000000);
								return ;
							...
							else if(jumlah_nendang == 3 || jumlah_nendang ==4)
							{
								if(pan <= 2)
								{
									cout<<"mode 2"<<endl;
									Walking::GetInstance()->Stop();
									fprintf(stderr,"nendang nyamping \n");	
									Tendang();
									usleep(2000000);
									Action::GetInstance()->Start(133); 
									usleep(8000000);
							...
							else if (jumlah_nendang > 4)
							{
								if (pan > 3)
								{
									...
									Tendang();
									usleep(1000000);
									Action::GetInstance()->Start(132); // gada motion di nomer 50
									usleep(8000000);
									cobaberhen();
									usleep(4000000);
									return ;
