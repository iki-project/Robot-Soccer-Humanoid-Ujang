...
Walking::Walking()
{
	...
	m_Joint.SetAngle(JointData::ID_R_SHOULDER_PITCH, -48.345); //-48.345
	m_Joint.SetAngle(JointData::ID_L_SHOULDER_PITCH, 41.313); //41.313
	m_Joint.SetAngle(JointData::ID_R_SHOULDER_ROLL, -17.873); //17.873
    m_Joint.SetAngle(JointData::ID_L_SHOULDER_ROLL, 17.580); //17.580 
